                                ...
                                <div className="team_img">
                                    ...
                                    <div className="col-md-9 col-12 col-sm-12">
                                        <div className="col-md-12">
                                            <h3 className="font_bold team_title" style={{ marginBottom: '0px !important', color: '#006C44', fontFamily: "Kantumruy Pro", fontWeight: 'bold'}}>{member.enFirstName} {member.enLastName}</h3>
                                            <h5 className="font_bold team_sub_title" style={{color: '#006C44', fontFamily: "Kantumruy Pro"}}>{member.enPosition}</h5>
                                        </div>
                                        <div className="blockquote blockquote-fancy quote_center_team">
                                            <p style={{color: 'black', fontFamily: "Kantumruy Pro"}}>{member.enQuote}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
